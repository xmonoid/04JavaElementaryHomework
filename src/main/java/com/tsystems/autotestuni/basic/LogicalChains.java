...
/**
 * To practice with ints and boolean.
 *
 * @author ekosykh
 */
public final class LogicalChains {
    ...
    /**
     * Check that input integer does not belong to the segment 5 to 50 (exclusive).
     *
     * @param number input integer
    ...
    /**
     * Check that input integer belongs to the segment -50 to -5 or 5 to 50 (inclusive).
     *
     * @param number input integer
